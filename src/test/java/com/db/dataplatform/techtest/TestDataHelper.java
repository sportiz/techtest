...
public class TestDataHelper {
    ...
    public static DataEnvelope createTestDataEnvelopeApiObjectWithEmptyName() {
        DataBody dataBody = new DataBody(DUMMY_DATA);
        DataHeader dataHeader = new DataHeader(TEST_NAME_EMPTY, BlockTypeEnum.BLOCKTYPEA, MD5_CHECKSUM);
    ...
    public static DataEnvelope createTestDataEnvelopeApiObjectWithInvalidCheckSum() {
        DataBody dataBody = new DataBody(DUMMY_DATA);
        DataHeader dataHeader = new DataHeader(TEST_NAME_EMPTY, BlockTypeEnum.BLOCKTYPEA, MD5_CHECKSUM + "wdew");
